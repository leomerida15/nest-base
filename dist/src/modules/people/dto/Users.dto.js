...
const Rols_db_1 = require("../table/Rols.db");
class UsersDTO extends Base_dto_1.BaseDTO {
}
__decorate([
...
__decorate([
    ...
    __metadata("design:type", String)
], UsersDTO.prototype, "firsName", void 0);
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_transformer_1.Transform)((param) => String(param.value).toLowerCase()),
    __metadata("design:type", String)
...
__decorate([
    (0, decorations_DC_1.IsTypes)(["number", Rols_db_1.RolsDB]),
